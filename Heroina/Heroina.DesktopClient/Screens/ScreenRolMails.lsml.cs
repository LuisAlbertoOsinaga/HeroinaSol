...
{
    public partial class ScreenRolMails
    {
        #region Propiedades
        #endregion
        ...
        partial void ScreenRolMails_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            InitDataWorkspace();
        }
        ...
        partial void RolMailsAddNew_Execute()
        {
            if (Empresas.SelectedItem == null)
                return;

            RolEmail rolEmail = RolMails.AddNew();
            rolEmail.Empresa = Empresas.SelectedItem;
        }
