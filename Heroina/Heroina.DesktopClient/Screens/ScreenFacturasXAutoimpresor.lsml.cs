...
{
    public partial class ScreenFacturasXAutoimpresor
    {
        #region Propiedades
        ...
        private void CalculaTotales()
        {
            List<Factura> FacturasReporte = (from Factura f in DataWorkspace.ApplicationData.Facturas
                                             where f.Dosificacion.Autoimpresor == Autoimpresores.SelectedItem &&
        ...
        void Enablings()
        {
            ...
            comboAutoimpresores.IsEnabled = Autoimpresores.Count > 1 && Application.Current.User.HasPermission(Permissions.CambiarAutoimpresor);
        }
        ...
        partial void ScreenFacturasXAutoimpresor_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            InitDataWorkspace();
            FindControls();
            Bindings();
