...
{
    public partial class ScreenFacturasXDosificacion
    {
        #region Propiedades

        IContentItemProxy comboDosificaciones;
        ...
        void Bindings()
        {
            comboDosificaciones.SetBinding(System.Windows.Controls.ComboBox.ItemsSourceProperty, "Screen.Dosificaciones", System.Windows.Data.BindingMode.OneWay);
            comboDosificaciones.SetBinding(System.Windows.Controls.ComboBox.SelectedItemProperty, "Screen.Dosificaciones.SelectedItem", System.Windows.Data.BindingMode.TwoWay);
        ...
        private void CalculaTotales()
        {
            List<Factura> FacturasReporte = (from Factura f in DataWorkspace.ApplicationData.Facturas
                                             where f.Dosificacion == Dosificaciones.SelectedItem &&
        ...
        void Enablings()
        {
            ...
            comboDosificaciones.IsEnabled = Dosificaciones.Count > 1;
        }

        void FindControls()
        {
            comboDosificaciones = this.FindControl("ComboDosificaciones");
        ...
        partial void ScreenFacturasXDosificacion_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            InitDataWorkspace();
            FindControls();
            Bindings();
