...
{
    public partial class ScreenCausasAnulaciones
    {
        #region Propiedades
        #endregion
        ...
        partial void ScreenCausasAnulaciones_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            InitDataWorkspace();
        }

        partial void CausasAnulaciones_Loaded(bool succeeded)
        {
            Mensaje = CausasAnulaciones.Count == 0 ? "No hay 'Causas de Anulaciones' definidas para desplegar!" : string.Empty;
        }
